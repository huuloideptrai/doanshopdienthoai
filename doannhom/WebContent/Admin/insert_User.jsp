...
<jsp:include page="header.jsp"></jsp:include>
							...
							<div class="form-two widget-shadow">
								...
								<div class="form-body" data-example-id="simple-form-inline">
									<form class="themuser" action="${root}/taothu/ServletUser" method="post">
									 ...
									 <input type="text" name="name" class="form-control" id="exampleInputName2" placeholder="tên sản phẩm" value="<%=t1%>"> </div> 
									 <div class="form-group"> <label for="exampleInputEmail2">Mật khẩu</label>
									  <input type="password" name="pw" class="form-control" id="exampleInputEmail2" placeholder="mô tả" value="<%=t2%>"></div>
									   <div class="form-group"> <label for="exampleInputEmail2">Email</label>
									   	  <input type="text" name="email" class="form-control" id="exampleInputEmail2" placeholder="??" value="<%=t3%>"> </div>
									   	   <div class="form-group"> <label for="exampleInputEmail2">Sđt</label>
									   	  <input type="text" name="sdt" class="form-control" id="exampleInputEmail2" placeholder="100000 " value="<%=t4%>"></div>
 ...
 <div class="form-group"> <label for="exampleInputEmail2">Địa chỉ</label>
									   	  <input type="text" name="address" class="form-control" id="exampleInputEmail2" placeholder="chất lượng cao" value="<%=t6%>"> </div>
									   	 
									   	 								   	 
									   	  <input type="hidden" name="luachon" value="insert">
									   <button type="submit" class="btn btn-default w3ls-button">thêm</button> </form> 
									   <br>
									 <p1> <a href="${root}/taothu/Admin/manager_user.jsp" > Trở lại</a></p1>
								</div>
							</div>
						</div>
					</div>
