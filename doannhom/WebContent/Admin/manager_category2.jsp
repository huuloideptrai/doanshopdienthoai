					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						%>
						  <tr>
							...
							<td><%=category.getHide()%></td>
							<td>
							<a href="update_category.jsp?luachon=update&categoryID=<%=category.getCategoryID()%>"><img alt="" src="images/edit.png"></a>&nbsp;&nbsp; | &nbsp;&nbsp;
                            <a href="../ServletQLdanhmuc?luachon=delete&categoryID=<%=category.getCategoryID()%>"><img alt="" src="images/remove.png"></a></td>
						  </tr>
									<%} %>
									</tbody>
								</table>
