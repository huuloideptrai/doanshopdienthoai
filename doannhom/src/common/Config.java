...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/taothu/vnpay_return.jsp";
    public static String vnp_TmnCode = "QVPBD6TG";
    public static String vnp_HashSecret = "JHNWCAPLKCVLMSURRNGVEFYRZDUXCSCQ";
